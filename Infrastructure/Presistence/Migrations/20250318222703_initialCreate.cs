        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestUnits = table.Column<int>(type: "int", nullable: false),
                    Comments = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LapName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReferenceRange = table.Column<int>(type: "int", nullable: false),
                    MedicalId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_lapTests", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagingDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ImagingResult = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Comments = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MedicalRecordId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Radiations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Radiations_MedicalRecords_MedicalRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Radiations_MedicalRecordId",
                table: "Radiations",
